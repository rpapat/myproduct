...
from myproduct.connectors import sentry


@patch(
    'myproduct.connectors.sentry.raven.Client',
    return_value='sentry_client')
@patch('myproduct.connectors.sentry.config')
...
@patch('myproduct.connectors.sentry.sentry_client')
